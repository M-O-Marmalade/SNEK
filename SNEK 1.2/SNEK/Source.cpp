...
/*
			...
			*/
			...
			//cout << "GAME OVER\n\nPlay again? (Y/N)\n";
			screenString.replace((nScreenHeight * nScreenWidth) - 913, 9, "GAME OVER");
			screenString.replace((nScreenHeight * nScreenWidth) - 120, 24, ">Press [Z] to play again");
			screenString.replace((nScreenHeight * nScreenWidth) - 40, 18, ">Press [X] to quit");
